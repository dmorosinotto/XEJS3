...
(['entry'], function(System) {

System.register("greet", [], function (_export) {
	_export("default", greet);

	function greet() {
		for (var _len = arguments.length, who = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
			who[_key - 1] = arguments[_key];
		}

		var after = arguments[0] === undefined ? 1000 : arguments[0];

		if (typeof after !== "number") {
			var _ref = [5000, [after].concat(who)];
...
System.register("gen", [], function (_export) {
...
System.register("entry", ["greet", "gen"], function (_export) {
  var greet, Ciao;
  return {
    setters: [function (_greet) {
      greet = _greet["default"];
    }, function (_gen) {
      Ciao = _gen.gen;
    }],
    execute: function () {
      ...
      greet.apply(undefined, babelHelpers.toConsumableArray(Ciao(3)));
    }
  };
});
});
