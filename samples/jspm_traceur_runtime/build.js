...
(['my_startup'], function(System) {

System.register("greet", [], function($__export) {
  "use strict";
  var __moduleName = "greet";
  function greet() {
    var $__1,
        $__2,
        $__3;
    var after = arguments[0] !== (void 0) ? arguments[0] : 1000;
    for (var who = [],
        $__0 = 1; $__0 < arguments.length; $__0++)
      who[$__0 - 1] = arguments[$__0];
    if (typeof after !== "number")
      ($__1 = [5000, $traceurRuntime.spread([after], who)], after = ($__2 = $__1[$traceurRuntime.toProperty(Symbol.iterator)](), ($__3 = $__2.next()).done ? void 0 : $__3.value), who = ($__3 = $__2.next()).done ? void 0 : $__3.value, $__1);
    var names = who.join(' ');
    var printH1 = (function() {
      return document.body.innerHTML += ("<h1>Hello " + names + "</h1>");
    });
    setTimeout(printH1, after);
    console.log(("Will greet #" + who.length + " in " + after / 1000 + " sec"));
  }
  $__export("greet", greet);
  return {
    setters: [],
    execute: function() {
    }
...
System.register("Greeter", ["greet"], function($__export) {
  "use strict";
  ...
  return {
    ...
    execute: function() {
      $__export('default', (function() {
        var Greeter = function Greeter(s) {
          this.name = s;
        };
        return ($traceurRuntime.createClass)(Greeter, {greetAfter: function() {
            var $__2;
            var $__1 = arguments[0] !== (void 0) ? arguments[0] : {},
                nsec = ($__2 = $__1.nsec) === void 0 ? 3 : $__2,
                title = $__1.title;
            if (!title) {
...
System.register("my_startup", ["greet", "Greeter"], function($__export) {
  "use strict";
  var __moduleName = "my_startup";
  var greet,
      Greeter,
      zio;
  return {
    ...
    execute: function() {
      ...
      greet("XE", "ES6", "rocks!");
      greet();
      zio = new Greeter("Paperino");
      zio.greetAfter();
      zio.greetAfter({title: "Zio"});
      zio.greetAfter({nsec: 4});
    }
  };
});
